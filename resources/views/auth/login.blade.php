    ...
    <div class="max-w-md w-full space-y-8 glass-panel p-8 rounded-3xl border border-slate-800 shadow-2xl relative overflow-hidden">
        ...
        <div class="p-4 rounded-2xl bg-slate-800/80 border border-slate-700/60 space-y-2">
            ...
            <div class="grid grid-cols-2 gap-2">
                <button type="button" onclick="fillCredentials('admin@pgmanage.com', 'password123')" class="px-3 py-2 rounded-xl bg-pink-600/20 hover:bg-pink-600/30 border border-pink-500/40 text-pink-300 text-xs font-bold transition-colors text-center">
                    👑 Owner/Admin Login
                </button>
                <button type="button" onclick="fillCredentials('rahul@example.com', 'password123')" class="px-3 py-2 rounded-xl bg-emerald-600/20 hover:bg-emerald-600/30 border border-emerald-500/40 text-emerald-300 text-xs font-bold transition-colors text-center">
                    🏠 Resident Login
                </button>
            </div>
        </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="email" name="email" type="email" autocomplete="email" required value="{{ old('email', 'admin@pgmanage.com') }}"
